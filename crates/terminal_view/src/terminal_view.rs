...
use terminal::{
    ...
    Search, ShowCharacterPalette, TaskState, TaskStatus, Terminal, TerminalBounds, TerminalHint,
    TerminalHintState, ToggleViMode, assign_hint_labels,
...
mod tests {
    ...
    use terminal::HintLabel;
    use terminal::alacritty::hyperlinks::HyperlinkMatch;
    ...
    fn terminal_hint_sample_double(first: char, second: char) -> TerminalHint {
        TerminalHint {
            ...
            hyperlink: HyperlinkMatch::from((
                "https://example.com".to_string(),
                true,
                AlacPoint::new(AlacLine(0), AlacColumn(0))
                    ..=AlacPoint::new(AlacLine(0), AlacColumn(0)),
            )),
        }
    }
